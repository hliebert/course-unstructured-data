...
## Last-Updated: Do Feb 27 18:24:31 2020
######################################################################
...
for (op in municipalities$value[1:2]) {
    ...
    ## encoding on the site is broken for one entry
    ## proceed to next iteration/municipality, alternatively figure out correct encoding
    if (op == "Peñarrubia+Abra") next
    ...
    # Site may not respond if requests are sent too quickly
    ## Sys.sleep(2)
}
